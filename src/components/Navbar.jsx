...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:${personalInfo.emails.primary}?subject=Hiring Inquiry – Cloud %26 DevOps Portfolio&body=Hello Malaya,%0D%0A%0D%0AI came across your portfolio and would like to discuss a Cloud / DevOps opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;
