...
export const projects = [
  {
    ...
    links: {
      github: "https://github.com/dev0malaya",
      demo: "https://github.com/dev0malaya",
    },
    isFlagship: true,
  },
  {
    ...
    number: "02",
    badge: "☸️ Kubernetes Container Orchestration",
    title: "Full-Stack Application Deployment on Kubernetes",
    description:
      "Containerized and deployed a full-stack React, Node.js, and MySQL application on Kubernetes. Configured Kubernetes Deployments, ClusterIP/NodePort Services, and NGINX Ingress for high-performance application routing and internal communication. Integrated AWS Network Load Balancer (NLB), Route 53, and ACM for custom domain management and HTTPS security. Solved real-world pod connectivity, persistent storage, DNS resolution, and ingress controller routing challenges.",
    techTags: [
      "Kubernetes",
      "Docker",
      "React",
  ...
  },
  {
    id: "cicd-automation",
    number: "03",
    badge: "⚡ IaC & CI/CD Pipeline Automation",
    title: "CI/CD & Infrastructure Automation Project",
    description:
      "Built an automated DevOps pipeline orchestrating infrastructure provisioning and application deployment. Leveraged Terraform for Infrastructure as Code (IaC) on AWS, Ansible for automated server configuration management, Docker and Kubernetes for container deployments, and Jenkins / GitHub Actions for continuous integration and automated release testing.",
    techTags: [
      "AWS",
      "Docker",
      "Jenkins",
